...
public class ModBlockEntities {
    ...
    public static final Supplier<BlockEntityType<PenroseReactorPortBlockEntity>> PENROSE_REACTOR_PORT = BLOCK_ENTITY_TYPES.register(
            "penrose_reactor_port",
            () -> new BlockEntityType<>(
                PenroseReactorPortBlockEntity::new,
                false,
                ModBlocks.PENROSE_REACTOR_PORT.get()
            )
    );
